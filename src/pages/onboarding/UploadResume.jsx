...
const UploadResume = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 font-inter">
      <h2 className="text-3xl font-bold text-gray-900">Upload Resume</h2>
      <p className="text-sm font-Inter mt-2 text-[#8C8C8C] ">
      ...
      <label
        ...
        className="mt-6 w-[600px] h-90 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-gray-500 transition "
      >
  ...
  rounded-[6px] px-[16px] py-[12px] gap-[8px] w-[220px] h-[56px] 
  hover:bg-[#005582] transition whitespace-nowrap"
        >
